...

{
    ...
    public static string Notate(this BigDouble number, int normalDigits = 3, int mantissaDigits = 3 )
    {
       ...
       if (number < 1e6 && number > -1e6)
        ...
        {
            case 0: //Standard
                string numberString = (number / BigDouble.Pow(10, 3*BigDouble.Floor(number.exponent / 3))).ToString($"F{mantissaDigits}");
